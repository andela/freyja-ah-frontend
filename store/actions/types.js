...
export const INIT_SEND_MSG_REQUEST = 'INIT_SEND_MSG_REQUEST';

export const END_SEND_MSG_REQUEST = 'END_SEND_MSG_REQUEST';

export const SET_SENT_MESSAGE = 'SET_SENT_MESSAGE';
